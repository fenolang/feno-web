export default {
  ...
  suscribe: {
    ...
    subtitle: "Subscribe and get the latest news from the entire Gentpy team",
    email_label: "Email",
    btn: "Receive news"
  },
  index: {
    what: "What is",
    what_content: `Gentpy is a programming language totally dedicated to good web development, providing several features and increasing the scalability of your projects. Gentpy is a transpiled language to JavaScript and HTML so that the browser can understand the code.<br><br>
        With a clean, beautiful syntax and more features such as web components, layouts, meta single files, global storage, better SEO and much more we present Gentpy as your best choice for your next website &#x1F609; &#x1F49A;`,
    cards: [
      {
        ...
        content: `A new language, easier, more readable, stronger, more explicit, a better language.
              Gentpy is a language fully prepared to make your life easier,
              Built with TypeScript and transpiled to HTML and JavaScript.`
      },
      {
        image: "/components_banner.png",
        title: "Component-Oriented",
        content: `Gentpy accepts in a very fluid way the programming based on components, improves the 
      ...
      },
      {
        ...
        content: `When we work on a project, it is not only important to launch the first version but also 
              keep the code and update it more and more. When working with Gentpy this becomes much easier 
              by having everything you need.`
      }
    ],
    support: {
      title: "Support Gentpy",
      sub: `Working with Gentpy is totally free, so you can make a donation 
          and support us to continue improving every day more every detail and offer a better language`
    }
  },
  about: {
    title: "About Me",
    content: `¡Hola! &#x1F596; &#x1F49A; My name is <span class = "ft-green">Yahir Gomez Noyola</span> and i am the creator of Gentpy. I'm currently the only person in charge of the development of this language. I'm 16 years old and i started in the world of programming almost 4 years ago, I'm currently dedicated to web development. <br><br>

      Gentpy's idea was to develop a language that met a very complete framework capable of meeting the needs of the programmer increasing the speed of project development to a <span class="ft-green bold">200%</span> &#x26A1; &#x1F525;
  ...
  docs: {
    ...
    what: {
      sub: `Gentpy is a language that allows you to develop web pages in a much faster and more effective way.`,
      what_i_need: "What i need?",
      what_i_need_2: "You don't need much, Gentpy and its entire ecosystem is based on the following:",
      why_gentpy: "Why use Gentpy and not Html?",
      why_gentpy_sub: `When you use Gentpy you improve your productivity to the fullest by advancing in your project. With Gentpy you can define the structure and marking of your site with a simpler syntax and more advantages than HTML. Gentpy provides you with new tools to improve the interaction of your project with CSS styles and finally Gentpy has a much simpler and more powerful syntax to program EVERYTHING you imagine. When using Gentpy you have the following benefits:`,
      why_gentpy_things: [
        "Simpler syntax",
        "Cleaner code",
        "Faster development",
      ...
      gentpy_works: "Does Gentpy work everywhere?",
      gentpy_works_2: `No, Gentpy is dedicated to work in a specific work environment, it is currently impossible to implement Gentpy to other work environments with different folders, files, etc. But, it could happen in the future;)`,
      gentpy_and_stack: "Can I leave HTML, JS and CSS using Gentpy?",
      gentpy_and_stack_2: `Can you stop using HTML? YES! Can you stop using JavaScript? Yes! Can you stop using CSS? NO! Emmm ... What? Gentpy serves to do the same thing as HTML in a much better way and with better extra functionalities, it serves to do the same as JavaScript with fewer errors, cleaner and scalable code but its purpose is not to define the design of your site, it does It offers new features that improve the writing of your style sheets but you still have to make use of CSS.`,
      gentpy_and_web: "Does Gentpy only serve to develop websites?",
      gentpy_and_web_2: `Absolutely not, by means of a configuration that you can find in the documentation you can inform Gentpy that you will develop an application in the style of NodeJS, Gentpy will stop transpilating to simple JavaScript and will start transpilating to NodeJS.`,
      gentpy_and_electron: "Can I develop desktop applications with Gentpy?",
      gentpy_and_electron_2: `Not yet, BUT you will be able to do it in the future, we are working to achieve a fairly good compatibility between Gentpy and Electron so you can comfortably develop desktop applications using Gentpy language.`
    },
    eco: {
      sub: `There is an entire ecosystem around Gentpy, from language to libraries that you can use to improve the operation and power of your project`,
      cards: [
        {
          class: "pt40 spacing",
          title: "Gentpy",
          content: `Gentpy is the main thing of the whole ecosystem, it is the programming language you need for your next web project, with a clear syntax, error prevention and the implementation of innovative functions that will make your life easier.`
        },
        {
          class: "spacing",
          title: "GFlow",
          content: `GFlow is really what Gentpy lacked to work in a more interactive way, this library provides us with the ability to create multiple and infinite global stores that help us divide the logic of our applications such as: variables, functions, classes in different scripts which are globally accessible in our project. You can currently work with GFlow in different languages such as: Gentpy, JavaScript and TypeScript.`
        },
        {
          class: "spacing",
          title: "GStyled",
          content: `GStyled is a framework that provides us with a large number of Gentpy components already stylized with CSS and JavaScript ready for you to use in addition to implementing specialized functions and new concepts for Gentpy such as: GSC (Gentpy Styles Config) that helps us explicitly specify how our style sheets will be communicated, in which .cct files they will work and even add variables and properties to our styles by managing the code cleanliness again and taking your project to the next level.`
        }
      ],
    ...
    lifecycle: {
      sub: "So how does Gentpy work? Here's the lifecycle:"
    },
    install: {
      sub: "There are 2 ways to install Gentpy:",
      cli: {
        title: "Gentpy CLI",
        sub: `Gentpy CLI is a command line interface that will facilitate the creation of projects with Gentpy, you just need to install it using`,
        ...
        gentpy_plugins: "Select Gentpy libraries and frameworks",
      ...
      scratch: {
        ...
        install_Gentpy_nodemon: `Then it is time to install Gentpy and nodemon by running the following command:`,
        ...
        create_index_gentpy: `And now we can create our first page of our project, to start add a file called <span class="bold">index.cct</span> inside the folder <span class="bold">scripts</span> e insert the following into:`,
        hello_world: "Hello World",
        run_project: "Finally we just have to run the following command to execute our project",
        running_project: "And ready! Your new project with Gentpy is running in",
        continue_docs: "If you want to know more about each folder and its function continue visiting"
      }
    },
    structure: {
      sub: "The time has come to know what each folder and file that makes up the structure of Gentpy serves",
      folders: [
        {
          title: "Pages Folder",
        ...
        {
          title: "Meta Folder",
          desc: `The folder called <span class="bold">meta</span> is where we should place all the individual meta files for our Gentpy pages`
        },
        {
          title: "Styles Folder",
      ...
      files: [
        {
          title: "Index.js File",
          desc: `The <span class="bold">index.js</span> file is the main file of the entire structure, it is responsible for putting in the Gentpy instance, you will not have to touch this file unless you install a library or framework for Gentpy as: <span class="bold">GFlow</span> or <span class="bold">GStyled</span>`
        },
        {
          title: "Nodemon.json File",
          desc: `The file called <span class="bold">nodemon.json</span> is the file that is responsible for configuring the nodemon dependency to observe the changes in the <span class="bold">.cct</span> files from Gentpy, you will never touch it in life ...`
        },
        {
    ...
    doc: {
      title: '<span class="ft-green">#Document</span> Instance',
      subtitle: 'The <span class="bold ft-green">#Document</span> instance it is the main object that encapsulates all the marking and structure of our website',
      define: {
      ...
      why: {
        title: "Why?",
        subtitle: "And you will ask: Why do we need to declare a principal instance that encapsulates our marking? The answer is simple: Gentpy needs to know where the structure of your website is, by declaring our document internally what is happening is the following:"
      },
      where_head: {
        title: "Where is the <head>?",
        subtitle: "In HTML we know of the existence of the important head tag, in Gentpy head it is an instance! If you want to know more about the #head instance continue visiting:"
      }
    },
    head: {
      title: '<span class="bold ft-green">#Head</span> Instance',
      subtitle: 'In Gentpy <span class="bold">head</span> it is an instance or object that we can declare to start placing our title and others',
      define: {
      ...
      elements: {
        ...
        title_el: {
          title: "Title",
          subtitle: 'In Gentpy we have the <span class="bold">title</span> element available within our #head instance, to assign a value we need to do the following:',
        ...
        scripts: {
          title: "Scripts",
          subtitle: 'To import external Gentpy scripts we use the <span class="bold ft-green">import()</span> function and to define a script in the same file we call the <span class="bold ft-green">{ Gentpy }</span> class',
          btns: [
            { text: 'See more about the&nbsp;<span class="bold">import()</span>&nbsp;function', route: "docs-meta_elements", id: "#import" },
            { text: 'See more about the&nbsp;<span class="bold">{ Gentpy }</span>&nbsp;class', route: "docs-gentpy_class" }
          ]
        },
        meta: {
      ...
      continue: {
        ...
        subtitle: "This is just the beginning of what you can learn about #meta and how to use good SEO on your next website with Gentpy",
        btn: "Continue learning about Gentpy"
      }
    },
    styles: {
      title: '<span class="ft-green">#Styles</span> Instance',
      subtitle: "We already learned about the #Doc instance and the #Head instance, now it's time to delve into the third and last instance of Gentpy: #Styles",
      defining: {
      ...
      under: {
        title: "Understanding the instance",
        subtitle: "When we want to insert css styles into our documents and not call an external file, it is when we use the #Styles instance, with the previous code actually what Gentpy is producing internally for the browser is the following:"
      },
      clean_title: "I want my styles in separate files!",
      clean_subtitle: 'No problem! For people like you cleaning enthusiasts Gentpy has the function <span class="ft-green">style()</span> Follow the documentation to know more and more of the best language you can use to develop your next project',
    ...
    meta: {
      ...
      under: {
        ...
        subtitle: "While we in Gentpy are only filling an element with properties internally what is happening is the following: (Taking as an example that we want to use the #description and #author property)"
      },
      func: {
        title: "Import functions",
        subtitle: 'Gentpy has 2 specialized functions to import external files with content for your document:'
      },
      style: {
      ...
      configure: {
        ...
        subtitle: "If you do not want to use the default styles folder for your styles you can configure another folder to use it by default so that Gentpy locates your .css files, see the #Styles section in the Gentpy configuration file guide:",
      },
      import: {
        title: 'The <span class="ft-green">#import</span> function',
        subtitle: 'The <span class = "ft-green"> import () </span> function performs the same as the <span class = "ft-green"> style () </span> function BUT this function only works for files with extension: <span class="bold">.gentpy</span>, the syntax is very simple:',
        file: 'gentpy_file_name',
      ...
      props: {
        ...
        view: {
          ...
          sub2: 'But Gentpy makes life easier for us so that to do the above we just have to write the word "viewport":'
        },
        base: {
          name: 'Base',
          sub: 'In Gentpy <span class="bold">IT IS NO LONGER NECESSARY</span> to place the base property that we place in HTML since the same language does it automatically for us;)'
        },
        noscript: {
          name: 'Noscript',
          sub: 'There are ways to disable javascript in our browser so that we have to be prepared for these types of situations. Gentpy gives us the NoScript object:',
        ...
        nojs_default: {
          ...
          sub: "If you don't define any noscript object then Gentpy adds one by default so you don't have to worry about anything :)"
        },
        configure_nojs: {
          name: 'Configure default Noscript',
          sub: "Now, we know that if we want to customize our noscript object we have to define it in each file, that's tired! The solution could be to create a component that only contains our noscript object and call it on each page, but it is still dirty. <br> <br> The solution that Gentpy provides us is to configure and customize the noscript object that Gentpy by default adds, this is done in the Gentpy configuration file. Click on the following link and see all about how to configure the noscript object"
        },
        more: {
          name: 'More properties',
          sub: 'Of course there are many more properties than the previous ones, but this would be redundant, so you can visit <a href="https://htmlhead.dev/#meta" target="_blank" class="ft-green">https://htmlhead.dev</a> and see all the properties of the meta in HTML as they also work in Gentpy, BUT remember that if in HTML it is like this:'
        },
        in_gentpy: 'In Gentpy is more clean, like this:'
      }
    },
    gentpy_class: {
      title: 'The <span class="ft-green">#Gentpy</span> Class',
      subtitle: "The #Gentpy class is the main element of everything and that is where the magic will arise, where we will use nothing more and nothing less than just syntax that Gentpy understands",
      comment: "Nothing around here .. again",
      start: {
        title: "Starting the class",
        subtitle: "To start programming in pure Gentpy we need to create the { Gentpy } class as follows at the end of our .gentpy files:"
      },
      hw: {
        title: "Your first Hello World in Gentpy!",
        subtitle: 'As a first exercise you could not miss the typical "Hello World", and this is how we do it in Gentpy:',
        val: 'Hello World in Gentpy!',
        result: 'Compile the code and open your browser, go to the console and you will see a message saying: <span class="bold">Hello World in Gentpy!</span>'
      },
      better_hw: {
    ...
    msf: {
      ...
      subtitle: 'One of the reasons for the existence of Gentpy is to present an improvement in the cleanliness of the code compared to other alternatives and we know that writing the "meta tags" or elements of the meta in each file next to our marking is dirty and in the long run It is a bad practice. Gentpy introduces you: the individual #meta files',
      what: {
        title: 'What are the meta files?',
        subtitle: 'Meta Single Files are a novelty that Gentpy implements to separate the Meta element from your pages. In such a way that you can create a file that is only for the meta of your page and Gentpy will automatically attach its content to the corresponding page.',
      },
      why: {
        title: 'Why use them?',
      ...
      how: {
        ...
        subtitle: 'Gentpy will automatically locate your meta files and apply their content to the destination page but for that each meta file has to be called according to certain rules: it must start with an underscore and must have the same name as the page for which the goal will be :'
      },
      create: {
        title: 'Creating a Meta Single File',
        subtitle: 'Suppose we have a file called: index.gentpy with the following document:',
        creating_one: 'Now we have to go to the folder called "meta" and create a new file called: _index.gentpy. Why? Because the meta files should always start their name with an underscore and then the name of the page / document to which it will be assigned. We have a document called "index.gentpy" so that the meta file must be called "_index.gentpy"',
        with_content: 'And in that new meta file we place the following content:',
        result: 'And ready! We have our first individual #meta file, Gentpy will now know that the index.gentpy file is assigned a meta file so the two files will be merged and the final document that Gentpy will transpire will be as follows:',
        alert: 'If on the landing page (in this example the landing page is: "index.gentpy") you already have a meta element declared within the #Head instance then the contents of the meta file will NOT APPLY'
      },
      default: {
        title: 'Define a default meta file',
        subtitle: 'Gentpy also gives us the option to create a meta file that is used by default when we do not create a meta file for a page. We just have to create a new file in the folder called "meta" named: "default.gentpy" And that\'s it! Now if we do not apply any meta for a file, this meta will be applied by default',
    ...
    compos: {
      ...
      create: {
        ...
        subtitle: 'We will go to the folder called "components" and inside we will create a new file called for example: "miboton.gentpy" and inside we will place the following content:',
        go_to: 'Now we will go to our main page: "index.gentpy" and call our component through the function:',
        ...
        res: 'And ready! Gentpy will call the component "mybutton" on the "index" page so even if we don\'t see it, the final document that will be transpired for the browser will be the following:',
    ...
    props: {
      ...
      newone: {
        ...
        result: 'And so we tell Gentpy that we are waiting for a property called prop and we want him to place it before our message that says "Welcome buddy", just with "${}" and in square brackets place the name of the property you want to place. <br> <br> Taking into account that we already send a property with its value and we already receive it in the component, what we will see in the browser will be the following:'
      },
      two: {
    ...
    layouts: {
      ...
      create: {
        ...
        subtitle: 'To create a layout we must obviously go to the "layouts" folder and then create a file with a .gentpy extension, for example we will create one called: "design.gentpy" and place the following content'
      },
      app: {
        title: 'The appView() function',
        subtitle: 'The appView() function only works for layouts and serves to render the content of your pages in such a way that Gentpy will search where you placed this function and there it will place the content of your pages that have that layout applied'
      },
      apply: {
        title: "Let's apply the layout",
        subtitle: 'We have already created our layout "design" so now we must apply it to the document we want, for example the index.gentpy:'
      },
      property: {
      ...
      result: {
        title: 'The result',
        subtitle: 'We have already created a layout called: "design.gentpy" and we have already assigned it to our page "index.gentpy" with the property this.layout, Now we can compile and go to our browser, you will notice that you will get a result like the following :',
        subtitle2: 'It worked! We went to our "index" page and we observed that our layout was perfectly applied to our content, this is only part of everything you can do with Gentpy;)'
      }
    },
    attr: {
      title: 'Attributes',
      ...
      subtitle2: 'Attributes in Gentpy:',
      mytext: 'mytext',
      func: 'myFunction',
      hello: 'Hello!',
      click: {
      ...
      to: {
        subtitle: 'In HTML you may have known it as href, in Gentpy it is just a simple "To" and serves to specify the URL of a link'
      },
      src: {
        subtitle: 'The well-known src attribute in HTML is used to call an image using its local path or link',
        img: 'myimage',
        alert: 'This attribute is NO LONGER required to place images since Gentpy has a specialized function for that: img()'
      },
      size: {
      ...
      more: {
        ...
        subtitle: 'Obviously there are more attributes but that is already a matter of HTML, just remember that the attributes in Gentpy start with capital letters if the name of the attribute is a single word like the attribute "rows" in Gentpy is:',
        subtitle2: 'BUT if the name of the attribute IS A COMPOSITION OF 2 WORDS then we make use of CamelCase\'s rules: <a href="https://wikipedia.org/wiki/Camel_case" target="_blank" class="ft-green bold">wikipedia.org</a>, for example the" cellpadding "attribute in Gentpy is like this:'
      }
    },
    variables: {
      title: 'Declaration of variables',
      subtitle: 'We know that in JavaScript there are 3 types of variables: <span class="bold">var</span>, <span class="bold">let</span> and <span class="bold">const</span>, Gentpy being a JavaScript extension allows you to still use these methods BUT Gentpy presents you with a much better way to work with variables',
      result: 'Result:',
      hello: 'Hello!',
      and: 'and Hello!',
      human: 'human',
      ...
      def: {
        title: 'def variables',
        subtitle: 'In Gentpy we use the reserved word <span class="bold">def</span> to define a new variable (Gentpy will automatically know when it is better to transpile to <span class="bold">var</span> or <span class="bold">let</span>)',
        subtitle2: 'With the previous code we can see the use of "def", some mathematical operations and we can also notice that Gentpy is a language <span class="ft-green">strongly typed</span> so that we cannot add a number to a text'
      },
      const: {
        title: 'Constants',
        subtitle: 'The constants are variables that once defined its value can no longer change, in Gentpy we wanted to preserve the way they are defined in JavaScript:',
        subtitle2: 'We can see that we CANNOT redefine the value of a constant and this is not the only thing to learn about variables in Gentpy: continue with the next lesson to learn about Typing'
      }
    },
    types: {
      title: "Typing",
      subtitle: "Gentpy is a strongly typed language, which means that each variable has a fixed type and it must be respected. It is not necessary to place the type when a variable is declared since Gentpy does it automatically but you can do it if you want",
      hw: "Hello World!",
      string: {
        subtitle: "String is the type that Gentpy provides for text variables and this is how we use it:",
        subtitle2: "The two variables will produce the same result, only above that we decided to place the type manually while internally Gentpy has already placed the String type for us :)",
        var: "hello"
      },
      number: {
      ...
      array: {
        ...
        var: "vector",
        var2: "multi_vector",
        alert: "There are no interfaces in Gentpy yet, so we still cannot specify the types allowed in an Array!"
      },
      object: {
    ...
    class: {
      title: "Classes",
      subtitle: "Gentpy offers a special experience when working with object-oriented programming",
      user: "User",
      msg: "msg",
      hw: "Hello World!",
      greet: "greet",
      ...
      super: {
        title: "Inheritance",
        subtitle: "Inheritance is key in object-oriented programming and is very easy to implement in Gentpy:",
    ...
    func: {
      title: "Functions",
      subtitle: "Functions are probably one of the most important things in a language and in Gentpy it is no exception.",
      hw: "Hello World!",
      msg2: "message",
      show: "show",
      create: {
    ...
    scripts: {
      ...
      subtitle: "Throughout this documentation we have put examples of Gentpy as the following:",
      subtitle2: "Normal, right? We start a Gentpy class and place a print () function. Now the question is: Whenever we want to start writing Gentpy code do we need to start an instance? ... NO!",
      hw: "Hello World!",
      text: "text",
      result: "Result:",
      hello: "Hello!",
      files: {
        title: "Gentpy Files",
        subtitle: 'We know that to encode in Gentpy we need to create a file <span class="bold">.gentpy</span> and apart we need to create an instance but this should ONLY be done if we are going to place HTML in the same file. If we are NOT going to place HTML in the same file then there is no need to place any instance, for example:',
        subtitle2: "Did you notice that we don't place the Gentpy class? The above code will work perfectly and will be transpiled to a javascript file, BUT, what happens if we do the following? ",
        subtitle3: "When compiling the previous code, Gentpy will notice that you placed the #DOC instance so automatically this file will no longer be transpiled to a .js file but to an .html file, then it will search if you declared the Gentpy class and if you did not, it will end up transpiling and will launch your code to the browser as a total and pure HTML markup."
      },
      examples: "Traspilation examples",
      pure: "Pure Gentpy",
      class: "With Gentpy Class",
      without: "Without Gentpy Class",
      alert: "In the latter case, Gentpy will remove all content that is not markup and that is not within the indicated class BUT not without notifying us through a warning that we have a badly declared code."
    },
    import: {
      title: "Import",
      ...
      func: {
        ...
        subtitle: 'As you can see we are only importing the run () function found in the file "script.gentpy" and we are executing it at the end'
      }
    },
    export: {
      title: "Export",
      subtitle: "Exporting in Gentpy is the same way you know so much:",
      hello: "hello",
      hello2: "hello2",
      normal: {
        title: "Normal export"
    ...
    crystals: {
      subtitle: "Crystals are an exclusive feature offered by Gentpy to improve the interactivity of our code and leave the use of parameters to change the way our code works.",
    ...
    config: {
      ...
      subtitle: 'Every Gentpy project has a configuration file called: <span class="bold">gentpy.config.js</span> and is the configuration file that Gentpy takes for your project',
    ...
    img: {
      ...
      class: "myclass",
      params: "Params",
      after: "Now you know a better and cleaner way to call your images with Gentpy;)"
    }
  },
}